...
/**
 * Bottom sheet for bug reports and feature ideas. Reports go to the feedback
 * table (admin-only read, /admin/feedback).
 *
 * Controlled: the trigger lives elsewhere (the header help menu) and drives
 * `open`/`onOpenChange`. This used to own its own trigger button; it was folded
 * into the combined help menu so the header shows one icon instead of three.
 */
